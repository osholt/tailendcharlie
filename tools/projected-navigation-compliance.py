...
def structural_checks(failures: list[str]) -> None:
    ...
    require_text(
        ...
        [
            ...
            "updateAutomaticGroupOverview",
            "CarPlayTecBarPresentation",
    ...
    require_text(
        ...
        [
            ...
            "testCarPlayTecBarPrioritisesTheDistance",
            "testCarPlayAutomaticGroupOverviewWaitsForAStableQuietStretch",
            "testCarPlayAutomaticGroupOverviewReturnsBeforeTheTurn",
            "testCarPlayAutomaticGroupOverviewYieldsToPriorityEvents",
